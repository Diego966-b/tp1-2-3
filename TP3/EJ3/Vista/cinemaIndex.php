...
<body>
    <div class="container">
        ...
        <form name="formulario" id="formulario" class="row g-3" action="../Control/cinemaValidar.php" method="post" enctype="multipart/form-data">
            <div class="col-md-6">
            ...
            <p>Ingrese la portada de la pelicula:</p>
            <input type="file" id="miArchivo" name="miArchivo" accept=".jpg, .jpeg, .png">
